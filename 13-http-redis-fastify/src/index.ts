// =================================================================
//  index.ts - Product Service with Redis Cache Example (Fastify)
...
async function main() {
  console.log('--- Running Product Service with Redis Cache Example (Fastify) ---');
  ...
  try {
    logger.info('🚀 Starting Product Service with Redis cache (Fastify)...');
