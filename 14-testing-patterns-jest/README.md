...
- How to avoid testing external dependencies and framework internals
...
Available mocks:
- `createTestHelper` / `createSyntropyLogMock` - Full framework simulation in memory
- `MockSerializerRegistry` - For testing custom serializers (see example 15)
- `createMockLogger` - For testing code that uses loggers
...
5. **Try other examples**: Check example 13 (Vitest) and other testing examples
...
- **Example 15**: Testing serializers
- **Example 16**: Testing transport concepts
