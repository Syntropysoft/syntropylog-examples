// =================================================================
//  index.ts - Product Service with Redis Cache Example (Koa)
...
async function main() {
  console.log('--- Running Product Service with Redis Cache Example (Koa) ---');
  ...
  try {
    logger.info('🚀 Starting Product Service with Redis cache (Koa)...');
